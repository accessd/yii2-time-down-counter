<?php
namespace accessd\yii2\Yii2TimerCountDown;
...
class Yii2TimerCountDown extends Widget
{
     ...
     */
    public $countDownOver = "Теперь можно начать тестирование";
    ...
    createCookie(name, "", -1);
         ...
         if (readCookie("$this->countDownIdSelector") != undefined) count = readCookie("$this->countDownIdSelector");
         createCookie("$this->countDownIdSelector", count, 365);
            timeDownCounter({
