...
`php composer.phar require --prefer-dist accessd/yii2-time-down-counter "*@dev"`

or add

`"accessd/yii2-time-down-counter": "*@dev"`
...
```
<?php
    use accessd\yii2\Yii2TimerCountDown\Yii2TimerCountDown;
?>
